...
<body class="bg-light">
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<ul class="navbar-nav">
					<li class="nav-item active"><a class="nav-link" href="/adminhome">Inicio (admin)</a></li>
					<li class="nav-item active"><a class="nav-link" href="/logout">Cerrar sesión</a>
					</li>
	...
	<div class="container">
		...
		<button type="button" style="margin: 20px 0" class="btn btn-primary"
			data-toggle="modal" data-target="#exampleModalCenter">Añadir categoría</button>
					...
					<form action="sendcategory" method="get">
						...
						<div class="modal-body  text-center">
							<input type="text" name="categoryname" class="form-control"
								id="name" required="required" placeholder="Nombre de categoría">
						</div>
					...
					<td>
						<form action="categories/update" method="get">
							...
							<button type="button" class="btn btn-warning" data-toggle="modal"
								...
								onclick="document.getElementById('categoryname').value =  '<%=rs.getString(2)%>'; document.getElementById('categoryid').value =  '<%=rs.getString(1)%>'; ">Actualizar
							</button>
