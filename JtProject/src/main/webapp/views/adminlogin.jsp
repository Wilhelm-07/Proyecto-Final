...
<div class="container my-5" style="width: 1800px;" ><br>
        ...
        <div class="jumbotron border col-sm-5 mx-auto">
            <h2 class="text-center">Inicio de sesión (administrador)</h2><br>
            <form action="loginvalidate" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control form-control-lg border border-danger	" placeholder="Contraseña admin" required name="password" id="password">
                </div><br>
